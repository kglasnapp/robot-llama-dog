import board # Start of Main program for control of Robot Llama
import select
import sys
from math import atan2, pi, radians, cos, sin, atan
import numpy as np

i2c = board.I2C()
# Map x that has a range inMin, inMax to outMin, outMax
def map( x, inMin,  inMax, outMin, outMax):
  return (x - inMin) * (outMax - outMin) / (inMax - inMin) + outMin

# Show the I2C device addresses on the bus
def showI2C():
